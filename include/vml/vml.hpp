...
// +------------------------------+-----------------+--------+
// | VML_DEBUG_LEVEL              |              0  |       0|  On Debug Level 0 all assertions and API validations
// |                              |                 |        |  are disabled.
...
// |                              |                 |        |
// +------------------------------+-----------------+--------+
// | VML_SAFE_MATH                |              0  |       1|  If disabled some math operations like exp(complex),
// |                              |              1  |        |  sin(complex) and norm(vector) don't handle overflow
// |                              |                 |        |  correctly. Disabling this will speed up these
// |                              |                 |        |  operations.
// +------------------------------+-----------------+--------+
// | VML_DEFAULT_PACKED           |              0  |       0|  If enabled vectors and matrices use 'Packed' memory
...
// |                              |                 |        |  parameter.
// +------------------------------+-----------------+--------+
// | VML_NAMESPACE_NAME           |            Any  |     vml|  Change the name of the 'vml' namespace. Can be useful
